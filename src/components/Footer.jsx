...
import { Github, Globe, User, Code2, Heart, Cpu, Coffee, Sparkles } from 'lucide-react';
       ...
       <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
          ...
          <div className="space-y-5">
             <h3 className="flex items-center gap-2 text-sm font-bold text-white font-mono uppercase tracking-wider">
                ...
                <span className="bg-clip-text text-transparent bg-linear-to-r from-white to-zinc-500">Mission Protocol</span>
             </h3>
             <div className="relative pl-4 border-l-2 border-white/10">
                <p className="text-xs text-zinc-400 leading-relaxed font-sans">
                   Moodify bridges the gap between biological emotion and digital auditory experience. 
                   A real-time experiment in AI interaction.
                </p>
          ...
          <div className="space-y-5">
             <h3 className="flex items-center gap-2 text-sm font-bold text-white font-mono uppercase tracking-wider">
                ...
                <span className="bg-clip-text text-transparent bg-linear-to-r from-white to-zinc-500">Neural Engine</span>
             </h3>
             <div className="flex flex-wrap gap-2">
                {[
                  { name: "React 18", color: "hover:border-blue-400/50 hover:text-blue-300" },
                  { name: "FaceAPI", color: "hover:border-red-500/50 hover:text-red-400" },
                  { name: "Spotify Web API", color: "hover:border-green-400/50 hover:text-green-300" },
                  { name: "Tailwind", color: "hover:border-cyan-400/50 hover:text-cyan-300" },
                  { name: "Vite", color: "hover:border-purple-400/50 hover:text-purple-300" }
                ].map((tech) => (
                   <span key={tech.name} className={`px-3 py-1.5 bg-[#0a0a0a] border border-white/10 rounded-md text-[10px] font-mono text-zinc-400 uppercase tracking-wide transition-all duration-300 hover:bg-white/5 hover:scale-105 cursor-default ${tech.color} shadow-sm`}>
                     {tech.name}
                   </span>
                ))}
             </div>
          ...
          <div className="space-y-5">
             <h3 className="flex items-center gap-2 text-sm font-bold text-white font-mono uppercase tracking-wider">
                ...
                <span className="bg-clip-text text-transparent bg-linear-to-r from-white to-zinc-500">Creator</span>
             </h3>
             ...
             <div className="group p-4 rounded-xl bg-linear-to-br    transition-all">
                <div className="flex items-center gap-3 mb-3">
                   ...
                   <div>
                      ...
                      <p className="text-[10px] text-zinc-500 font-mono">FULL STACK DEVELOPER</p>
                   </div>
                </div>
                ...
                <div className="flex items-center gap-2 text-xs text-zinc-400 mt-2">
                   ...
                   <span className="font-bold text-white flex items-center gap-1.5 bg-red-500/10 px-2 py-0.5 rounded border border-red-500/20">
                      Gupta Ji <Heart size={10} className="text-red-500 fill-red-500 animate-pulse" />
                   </span>
                </div>
             </div>
          </div>
